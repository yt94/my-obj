...
(function() {
    // 获取相关元素
    var tabBtns = document.querySelectorAll('#asideTabTitle span');  // 所有的选项卡按钮
    var tabItems = document.querySelectorAll('#asideTabContent .tab-item'); // 所有的选项卡选项
    ...
    tabBtns.forEach(function(tabBtn, index) {
        ...
        tabBtn.addEventListener('click', function() {
            ...
            tabBtns.forEach(function(item, itemIndex) {
                item.classList.remove('active'); // 去掉所有按钮的 active 类
                tabItems[itemIndex].classList.remove('active');  // 去掉所有选项的 active 类型
            });
